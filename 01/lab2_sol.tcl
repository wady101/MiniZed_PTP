...
#
# lab2_sol.tcl: Tcl script for re-creating project 'ZynqDesign'
#
# Generated by Vivado on Sat Jan 05 09:55:15 GMT 2019
...
#
# 1. This project restoration tcl script (lab2_sol.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/siybul/Speedway/ZynqDesign/ZynqDesign.srcs/sources_1/bd/Zynq_system/hdl/Zynq_system_wrapper.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../Speedway/ZynqDesign"]"

# Create project
create_project ${project_name} ./${project_name} -part xc7z010clg225-1
...
set files [list \
 "[file normalize "$origin_dir/../../Speedway/ZynqDesign/ZynqDesign.srcs/sources_1/bd/Zynq_system/hdl/Zynq_system_wrapper.v"]"\
]
...
set file "hdl/Zynq_system_wrapper.v"
...
cr_bd_Zynq_system ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files Zynq_system.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files Zynq_system.bd ] 
set_property IS_ENABLED "1" [get_files Zynq_system.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files Zynq_system.bd ] 
set_property IS_LOCKED "0" [get_files Zynq_system.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files Zynq_system.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files Zynq_system.bd ] 
set_property PFM_NAME "" [get_files Zynq_system.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Zynq_system.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files Zynq_system.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files Zynq_system.bd ] 
set_property USED_IN_SIMULATION "1" [get_files Zynq_system.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files Zynq_system.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z010clg225-1 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010clg225-1 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
