...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: audio_sink_0, and set properties
	set audio_sink_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:audio_sink:1.0 audio_sink_0 ]
	...
	# Connect all clock & reset of audio_sink_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins audio_sink_0/S_AXI]
	connect_bd_net [get_bd_pins audio_sink_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins audio_sink_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of audio_sink_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins audio_sink_0/M_AXI]
	connect_bd_net [get_bd_pins audio_sink_0/m_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins audio_sink_0/m_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins audio_sink_0/m_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins audio_sink_0/m_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins audio_sink_0/m_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of audio_sink_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {audio_sink_0/M_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells audio_sink_0]

	# Copy all address to audio_sink_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/audio_sink_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_audio_sink_0_S_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:audio_sink:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/audio_sink_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "audio_sink_v1_0_hw_${i}"
